...
Cerberus Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Cerberus Core, where everyone uses
...
pay attention to for reviewers of Cerberus Core code.

General Cerberus Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Cerberus Core uses tinyformat, which is type safe. Leave them out to avoid confusion
