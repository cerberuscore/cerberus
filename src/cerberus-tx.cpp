...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Cerberus Core cerberus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cerberus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cerberus transaction") + "\n" +
              "  cerberus-tx [options] -create [commands]   " + _("Create hex-encoded cerberus transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cerberus transaction
