...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CerberusNetwork") type = CerberusNetwork;
    if(strType == "CerberusNetworkVariable") type = CerberusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CerberusNetwork) s = "CerberusNetwork";
    if(type == CerberusNetworkVariable) s = "CerberusNetworkVariable";
