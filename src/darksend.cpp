...
{
    if(fLiteMode) return; // ignore all Cerberus related functionality
...
/*
    ...
    allow endless transaction that would bloat Cerberus and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("cerberus-privatesend");
