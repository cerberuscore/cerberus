...
This mechanism has been integrated into Bitcore-Node-Cerberus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cerberuscoin/insight-api-cerberus#web-socket-api](https://github.com/cerberuscoin/insight-api-cerberus#web-socket-api) 
* API: [https://github.com/cerberuscoin/insight-api-cerberus#instantsend-transactions](https://github.com/cerberuscoin/insight-api-cerberus#instantsend-transactions) 
...
By default, the Cerberus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cerberus Core daemon:
