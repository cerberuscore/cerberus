...
Only requiring some minor changes is cerberus.cpp.
...
Changes to cerberus.cpp
----------------------
cerberus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
