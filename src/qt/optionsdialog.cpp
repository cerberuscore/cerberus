    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CBS-light"), QVariant("light"));
    ui->theme->addItem(QString("CBS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CBS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CBS-traditional"), QVariant("trad"));
