    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Cerberus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cerberus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cerberus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Cerberus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cerberus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cerberus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cerberus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cerberus addresses"));
    ...
    openAction->setStatusTip(tr("Open a cerberus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cerberus Core help message to get a list with possible Cerberus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Cerberus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cerberus network", "", count));
}
...
{
    QString strTitle = tr("Cerberus Core"); // default title
